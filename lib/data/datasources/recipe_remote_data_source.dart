...
import 'package:recipes_app/data/models/remote/similar_recipe_response.dart';
  ...
  Future<List<SearchRecipeResponse>?> fetchRecipesByIngredients(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<SearchRecipeResponse> recipes = body
            .map((dynamic item) => SearchRecipeResponse.fromjson(item))
            .toList();
